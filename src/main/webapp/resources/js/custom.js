$(document).ready(function() {
	...
	$(".maskPhone").mask("99.999.999");
	$(".maskPhoneExt").mask("999.999.999.999");
	$(".maskIntPhone").mask("999.999.999");
	$(".maskTin").mask("999.999,99");
	$(".maskSsn").mask("999.999");
	$(".maskProd").mask("999.999,999", { placeholder: " " });
	$(".maskEye").mask("9.999,99");
	$(".maskPo").mask("999,99%");
	$(".maskPct").mask("999.999.999.999,9");
	$(".maskPct2").mask("99,999");
