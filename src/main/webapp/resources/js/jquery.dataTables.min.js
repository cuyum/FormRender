    ...
    var L= function(h) {
        var j= function(e) {
            ...
            function Ba(a) {
                ...
                a.oScroll.bAutoCss&&(c.style.overflow="hidden",c.style.position="relative",f.style.overflow="auto",i.style.overflow="auto");
                c.style.border="0";
                c.style.width="110%";
                f.style.border="0";
                d.style.width=""!==a.oScroll.sXInner?a.oScroll.sXInner:"110%";
            ...
            function La(a) {
                ...
                ""===a.oScroll.sX&&(d.style.width="110%",b.parentNode.style.width=
                    "110%");
                var t=N(a,i);
                i=0;
                ...
                if(""===a.oScroll.sX) {
                    if(a.nTable.style.width="110",r&&(h("tbody",d).height()>d.offsetHeight||"scroll"==h(d).css("overflow")))
                ...
                } else d.style.width=q("110px"),a.nScrollHead.style.width=q("110%"),null!==a.nTFoot&&(a.nScrollFoot.style.width=q("110%"));
            ...
            function Ua(a) {
                var b=h('<div style="position:absolute; top:0; left:0; height:1px; width:1px; overflow:hidden"><div style="position:absolute; top:1px; left:1px; width:110px; overflow:scroll;"><div id="DT_BrowserTest" style="width:110%; height:10px;"></div></div></div>')[0];
                l.body.appendChild(b);
                a.oBrowser.bScrollOversize=
                110===h("#DT_BrowserTest",b)[0].offsetWidth?!0:!1;
        ...
        j.defaults={aaData:null,aaSorting:[[0,"asc"]],aaSortingFixed:null,aLengthMenu:[10,25,50,110],aoColumns:null,aoColumnDefs:null,aoSearchCols:[],asStripeClasses:null,bAutoWidth:!0,bDeferRender:!1,bDestroy:!1,bFilter:!0,bInfo:!0,bJQueryUI:!1,bLengthChange:!0,
            ...
            },fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:110,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},
