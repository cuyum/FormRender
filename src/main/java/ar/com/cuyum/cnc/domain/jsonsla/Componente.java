...
public abstract class Componente implements Serializable {
	public transient static Logger log = Logger.getLogger(CncFieldValidator.class);
	...
	abstract public void setValueFromJson(JsonNode value) throws ExceptionValidation;
	...
	public boolean equals(Componente o) {
		if (!(o instanceof Componente))
			return false;
		return (
				ref == (((Componente)o).ref) &&
				id == (((Componente) o).id) &&		        
				title == (((Componente) o).title) &&
				appearance == (((Componente) o).appearance) &&
				hint == (((Componente) o).hint) &&
				label == (((Componente) o).label));
	}
